...
class App extends Component {
  ...
  render() {
    ...
    // example, fillIn and data  are example JSONs that will be replaced by server requests. When this is done it may be better to do the server requests in ElevatorElementList, but for now I had them stored here because of how bulky they are.
    // data is the JSON with the information for the unpopulated widget
    // fillIn is the JSON with the information that is used to populate the widgets
    //example is the JSON with the information used in element previews
